...
@Mod.EventBusSubscriber(modid = SettingsBrowserMod.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
public final class ClientInit {
    public static final KeyMapping OPEN = new KeyMapping("key.settingsbrowser.open", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_O, "key.categories.settingsbrowser");
    private ClientInit() {}
